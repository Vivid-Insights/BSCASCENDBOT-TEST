    ...
    parameters: {
      ...
      properties: {
        ...
        reportsExternalTreatment: {
          type: "boolean",
          description: "Did she describe something OTHER PEOPLE — or an automated/systemic process like an AI screening or scoring tool — did or might do to her? True for: being interrupted or talked over, her idea repeated back as someone else's, being paid less than a colleague, being passed over, being called difficult, being assumed junior, being dismissed or excluded, a specific thing someone said or did to her, OR naming a documented external risk to herself like algorithmic bias against her background in a hiring or screening tool — this is TRUE even when she frames it as a fear of what a system MIGHT do rather than something a person already did, since the risk itself is still external to her, not a trait of hers. FALSE only when she is describing herself with no external actor or system named at all — how she feels, what she avoids, what she does not believe, a habit of her own (going quiet, not applying, rechecking her work, not counting her wins, doubting praise). A feeling ABOUT other people is still false unless she reports what they actually did or names a specific external risk to herself. This is TRUE even when the same message ALSO asks a tactical question about what to do next ('a colleague earns more than me, how do I bring it up' is still a disclosure first) — the request for advice does not cancel out the disclosure sitting in front of it.",
        },
        newProfileFacts: {
          type: "boolean",
