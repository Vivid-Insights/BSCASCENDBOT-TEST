...
import { SALARY_AREA, GETTING_STARTED_AREA, MENTORSHIP_AREA, WELLBEING_AREA, CONFIDENCE_AREA, CAREER_PATHS_AREA, FURTHER_EDUCATION_AREA, JOB_SEARCH_AREA, INTERVIEW_PREP_AREA, AREA_TOPIC_TO_FUNCTION_NAME } from "./discussion-areas.ts";
